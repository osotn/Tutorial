...
bool PlayState::onEnter()
{
    ...
    object = TheGameObjectFactory::Instance()->create("Player");
    object->load(new LoaderParams(500, 100, 128, 55, "helicopter", 5));
    m_gameObjects.push_back(object);

    object = TheGameObjectFactory::Instance()->create("Enemy");
    object->load(new LoaderParams(100, 100, 128, 55, "helicopter2", 5));
    m_gameObjects.push_back(object);
