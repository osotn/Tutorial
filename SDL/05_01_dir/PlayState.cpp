...
bool PlayState::onEnter()
{
    ...
    m_gameObjects.push_back((GameObject*)new Player(new LoaderParams(500, 100, 128, 55, "helicopter")));
    m_gameObjects.push_back((GameObject*)new Enemy(new LoaderParams(100, 100, 128, 55, "helicopter2")));
